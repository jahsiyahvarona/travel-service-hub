...
public interface ReportRepository extends JpaRepository<Report, Long> {
    ...
    /**
     * Finds all reports associated with Report authored by a specific user.
     *
     * @param authorId The ID of the author.
     * @return List of Report entities.
     */
    List<Report> findByreporter_id(Long authorId);

    List<Report> findByPkgProviderDetailsId(Long id);
}
