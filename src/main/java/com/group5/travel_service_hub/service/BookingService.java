...
public class BookingService {
    ...
    public Booking createBooking(Long customerId, Long packageId, LocalDate startDate, LocalDate endDate) {
        ...
        Booking booking = new Booking(customer, pkg, startDate, endDate, BookingStatus.UNCONFIRMED, LocalDateTime.now());
    ...
    public List<Booking> getBookingsByProviderId(Long providerId) {
        return bookingRepository.findByPkgProviderDetailsId(providerId);
    }
